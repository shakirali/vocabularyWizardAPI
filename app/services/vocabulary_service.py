...
class VocabularyService:
    ...
    def get_all(
        ...
        return self.vocab_repo.get_all_with_filters(year=year, search=search, skip=skip, limit=limit)
    ...
    def update(self, vocabulary_id: uuid.UUID, item_data: VocabularyItemUpdate) -> VocabularyItem:
