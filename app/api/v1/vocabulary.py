...
from app.schemas.vocabulary import VocabularyItemCreate, VocabularyItemUpdate, VocabularyItemResponse
...
def get_vocabulary(
    ...
    items, total = vocab_service.get_all(year=year, search=search, skip=skip, limit=limit)
