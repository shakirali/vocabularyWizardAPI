#!/usr/bin/env python3
"""
Generate high-quality quiz sentences for Batch 4 words - Direct CSV generation.
"""

import csv
from pathlib import Path

# Pre-generated sentences for each word (already with blanks)
WORD_SENTENCES = {
    "gallant": [
    ...
    "garbled": [
        "The garbled message was impossible to understand.",
    ...
    "gasket": [
        "The mechanic replaced the worn gasket in the engine.",
    ...
    "gloomy": [
        "The gloomy weather matched her sad mood.",
    ...
    "glutton": [
        "He was such a glutton that he ate the entire cake himself.",
    ...
    "gnarled": [
        "The gnarled old oak tree had been there for centuries.",
    ...
    "goaded": [
        "He was goaded into losing his temper by constant teasing.",
    ...
    "grata": [
        "She was persona non grata after the argument.",
    ...
    "grieve": [
        "The family continued to grieve for their lost pet.",
    ...
    "gung-ho": [
        "The gung-ho new employee volunteered for every task.",
    ...
    "hamper": [
        "The heavy rain began to hamper the rescue efforts.",
    ...
    "harass": [
        "It is wrong to harass anyone because of their differences.",
    ...
    "harbour": [
        "The ships sailed into the safe harbour before the storm.",
    ...
    "hardy": [
        "The hardy plants survived the harsh winter frost.",
    ...
    "haughty": [
        "The haughty princess refused to speak to commoners.",
    ...
    "hearth": [
        "The family gathered around the warm hearth.",
    ...
    "hectic": [
        "The hectic morning rush left everyone exhausted.",
    ...
    "heeding": [
        "Not heeding the advice she continued anyway.",
    ...
    "heroic": [
        "The heroic firefighter rescued the family from flames.",
    ...
    "hiatus": [
        "The band took a hiatus from touring for a year.",
    ...
    "hinder": [
        "The heavy traffic hindered their journey to school.",
    ...
    "hostile": [
        "The hostile crowd made the visitors feel unwelcome.",
    ...
    "hubris": [
        "His hubris led to his eventual downfall.",
    ...
    "humane": [
        "The humane treatment of animals is very important.",
    ...
    "hybrid": [
        "The hybrid car uses both petrol and electricity.",
    ...
    "immerse": [
        "He liked to immerse himself in books during holidays.",
    ...
    "impede": [
        "The fallen tree impeded traffic for hours.",
        "The fallen tree would _____ traffic for several hours.",
    ...
    "impel": [
        "Her curiosity impelled her to investigate further.",
    ...
    "inane": [
        "His inane comments contributed nothing to the discussion.",
    ...
    "incense": [
        "The unfair decision incensed all the players.",
    ...
    "incite": [
        "It is illegal to incite violence against others.",
    ...
    "incline": [
        "The hill began to incline steeply towards the top.",
    ...
    "induce": [
        "The warm weather induced everyone to go outside.",
    ...
    "inept": [
        "The inept goalkeeper let in five goals.",
    ...
    "inert": [
        "The inert gas does not react with other chemicals.",
    ...
    "infer": [
        "From the clues we can infer who committed the crime.",
    ...
    "infuse": [
        "The tea was infused with the flavour of mint.",
    ...
    "inhale": [
        "She inhaled the fresh mountain air deeply.",
    ...
    "intact": [
        "Remarkably the ancient vase remained intact.",
    ...
    "irate": [
        "The irate customer demanded to see the manager.",
    ...
    "jabber": [
        "The excited children began to jabber all at once.",
    ...
    "jewel": [
        "The diamond was a beautiful jewel in her ring.",
...
def convert_to_blank(sentence: str, word: str) -> str:
    """Convert sentence to blank format"""
    import re
    word_lower = word.lower()
    patterns = [
        word, word_lower, word.capitalize(),
        word_lower + 'ed', word_lower + 's', word_lower + 'ing',
        word_lower + 'd', word_lower[:-1] + 'ing' if word_lower.endswith('e') else '',
        word_lower[:-1] + 'ied' if word_lower.endswith('y') else ''
    ]
...
def main():
    """Generate CSV file with quiz sentences"""
    output_file = Path(__file__).parent.parent / "data" / "quiz_sentences_batch4.csv"
    
    all_rows = []
    all_rows.append(['level', 'word', 'sentence'])
    
    for word, sentences in WORD_SENTENCES.items():
        # Take first 10 sentences
        for sent in sentences[:10]:
            blank_sent = convert_to_blank(sent, word)
            if "_____" in blank_sent:
                all_rows.append(['1', word, blank_sent])
    ...
    word_count = len(WORD_SENTENCES)
    sentence_count = len([r for r in all_rows if r[0] == '1'])
    print(f"Batch 4 complete: {sentence_count} sentences generated for {word_count} words")
